...
var React, import_with_selector, IS_REACT_19, REACT_ELEMENT_TYPE, REACT_PORTAL_TYPE, REACT_FRAGMENT_TYPE, REACT_STRICT_MODE_TYPE, REACT_PROFILER_TYPE, REACT_CONSUMER_TYPE, REACT_CONTEXT_TYPE, REACT_FORWARD_REF_TYPE, REACT_SUSPENSE_TYPE, REACT_SUSPENSE_LIST_TYPE, REACT_MEMO_TYPE, REACT_LAZY_TYPE, REACT_OFFSCREEN_TYPE, REACT_CLIENT_REFERENCE, ForwardRef, Memo, nullListeners, canUseDOM, isDOM, isRunningInReactNative, isReactNative, getUseIsomorphicLayoutEffect, useIsomorphicLayoutEffect, REACT_STATICS, KNOWN_STATICS, FORWARD_REF_STATICS, MEMO_STATICS, TYPE_STATICS, defineProperty, getOwnPropertyNames, getOwnPropertySymbols, getOwnPropertyDescriptor, getPrototypeOf, objectPrototype, ContextKey, gT, ReactReduxContext, NO_SUBSCRIPTION_ARRAY, stringifyComponent, hasWarnedAboutDeprecatedPureOption, connect_default, Provider_default, useReduxContext, useStore, useDispatch, refEquality, useSelector, batch;
var init_react_redux = __esm({
  "node_modules/react-redux/dist/react-redux.mjs"() {
    React = __toESM(require_react(), 1);
    import_with_selector = __toESM(require_with_selector(), 1);
    IS_REACT_19 = React.version.startsWith("19");
    ...
    REACT_OFFSCREEN_TYPE = /* @__PURE__ */ Symbol.for("react.offscreen");
...
//# sourceMappingURL=chunk-GALFPUKS.js.map
